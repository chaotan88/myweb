      ...
      <el-form :model="formData" :rules="rules" ref="formData" label-width="180px">
        ...
        <div class="commodity-details">
          ...
          <el-form-item label="商品主图：" class="picture">
            <thumbnail-component :list="formData.uploadMainFileList" :empty="false" :link="true" :auto-delete="true" del :styles="{width: '100px', height: '100px'}">
          ...
          <div v-if="formData.spec === 0">
            ...
            <el-form-item label="进货价：" prop="purchasePrice" style="margin-bottom: 20px;">
              <el-input v-model="formData.purchasePrice" placeholder="请输入价格" @change="getIntegralPoint" :disabled="formData.examine === 2" @blur="inpBlur('purchasePrice')"></el-input>
            </el-form-item>
            <!-- :required="formData.spec === 0 && formData.examine === 1" -->
            <el-form-item label="销售价：" prop="salePrice" style="margin-bottom: 20px;">
              <el-input v-model="formData.salePrice" placeholder="请输入价格" @change="getIntegralPoint" :disabled="formData.examine === 2" @blur="inpBlur('salePrice')"></el-input>
            </el-form-item>
            <el-form-item label="条形码：" prop="">
              {{formData.externalNo | filterEmpty}}
            </el-form-item>
            ...
            <el-form-item label="是否特卖商品：" class="sale-wrap">
              ...
              <template v-if="formData.isSale === 1">
                <el-form-item prop="sale">
                  <el-input v-model="formData.sale" :disabled="formData.examine === 2" @change="getIntegralPoint" placeholder="请输入特卖价格" style="width: 280px" @blur="inpBlur('sale')"></el-input>
                </el-form-item>
              </template>
            </el-form-item>
    ...
    methods: {
      ...
      getOriginsListByParam () {
        this.$http.post('@ROOT_API/goods/getOriginsListByParam', {
          attributeTypeId: this.formData.platformTypeId,
