...
<template>
  <third-menu>
    <template slot="main">
      ...
      <!-- <router-link class='d-ib ta-c' to="/admin/goods/manage/wait">未提交审核(0)</router-link> -->
      <router-link class='d-ib ta-c' to="/admin/goods/manage/index">待审核({{statistics.waitReviewNum || 0}})</router-link>
