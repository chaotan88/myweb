  ...
  <common-tpl :footer="false" class="manage-wrap column-wrap">
    ...
    <template slot="header">
      <high-search :textVisible="false">
        <template slot="edit">
          <el-button @click = "$router.push({path:'/admin/goods/column/manage/add'})"><i class="el-icon-plus fw-b"></i> 添加栏目</el-button>
        </template>
      </high-search>
    </template>
          ...
          <template slot-scope="scope">
            <el-dropdown class="d-b">
                ...
                <el-dropdown-menu slot="dropdown">
                  ...
                  <el-dropdown-item>
                    <div @click="$router.push({path: '/admin/goods/column/manage/edit', query: {id: scope.row.id}})"><i class="icon el-icon-edit"></i>编辑</div>
                  </el-dropdown-item>
                  <el-dropdown-item>
    ...
    <template slot="other">
      ...
      <!-- 关联弹窗 -->
      <el-dialog title="关联商品" :visible.sync="relationVisible" width="1000px">
        <relation-goods :relationKey="relationKey" :sort="true" :relationId="relationData.id" @change="relationDataChange"></relation-goods>
        <!-- <br>
        <br>
        <el-button @click="relationVisible = false">取消</el-button>
        <el-button type="primary" :loading="saveLoading" @click="handleRelation">{{saveLoading ? '关联中..' : '确定'}}</el-button> -->
      </el-dialog>      
    </template>
