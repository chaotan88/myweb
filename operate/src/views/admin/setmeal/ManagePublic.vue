...
<template>
  <common-tpl class="column-public-wrap" footer back>
    <template slot="main">
      ...
      <el-form :model="formData" :rules="rules" ref="formData" label-width="150px">
        ...
        <div class="relation pos-r" v-if="pageType === 1 && pageLevel === 1 || pageLevel === 2">
          ...
          <!-- 关联商品组件 -->
          <relation-goods :relationId="columnId" :relationType="2" :setNum="formData.setmealType === 1 ? !!true : !!false" @change="relationDataChange"></relation-goods>
          <!-- <relation-public :columnId="columnId" :setmealType="formData.setmealType" @change="relationDataChange"></relation-public> -->
    ...
    <template slot="footer">
      <el-button type="primary" :loading="loading" @click="submitForm('formData')">保存</el-button>
    </template>
   ...
   */
    ...
    submitForm (formName) {
      ...
      this.relationListData.forEach((row) => {
        ...
        addGoodsColumnPieces.push(json)
      })
