...
<template>
  <common-tpl class="management-details-wrap" footer back>
    <template slot="main">
      ...
      <gray-title title="订单信息"></gray-title>
        ...
        <el-table :data="tableData" style="width: 100%">
          ...
          <el-table-column prop="goodsImage" label="主图">
            <template slot-scope="scope">
              <a :href="scope.row.goodsImage | filterImgUrl" target="_blank" title="点击查看大图" v-if="scope.row.goodsImage">
                <img style="width: 60px; height: 60px;" :src="scope.row.goodsImage | filterImgUrl">
              </a>
...
export default {
  ...
  mounted () {
    ...
    this.tableData[0] = JSON.parse(localStorage.getItem(this.$global.SYSTEM + 'EvaluateDetails'))
