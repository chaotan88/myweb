            ...
            <template slot-scope="scope">
              <el-dropdown class="d-b">
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item>
                    <div @click="handleDetails(scope.row.id)"><i class="icon el-icon-edit"></i> 编辑</div>
                  </el-dropdown-item>
                </el-dropdown-menu>
              </el-dropdown>
            </template>
  ...
  export default{
    ...
    methods: {
      ...
      handleDetails (id) {
        ...
        // setTimeout(() => {
        //   this.$router.push({path: '/admin/finance/commission/vipRules/edit', query: {}})
        // }, 30)
        setTimeout(() => {
          this.$router.push({path: '/admin/finance/commission/vipRules/edit', query: {id: id}})
        }, 30)
      },
