<!-- 账户信息 -->
<template>
  <common-tpl class="seting-admin-wrap" footer>
    <template slot="main">
      <div class="my-info-wrap">
        <div class="my-info-cen">
          <h2 class="fw-n">基本信息</h2>
          <el-form label-position="right" :model="formData" :rules="rules" ref="form" label-width="160px">
            ...
            <el-form-item label="安全设置：">
              <el-button type="text" @click="passwordHandle = true">修改密码</el-button>
            </el-form-item>
          </el-form>
        </div>
        <br>
        ...
        <el-dialog
          title="修改密码"
          :visible.sync="passwordHandle"
          width="30%">
          <el-form :model="formData" :rules="rules" ref="form" label-width="140px" class="passwordClass">
            <span>
            ...
            <el-button @click="passwordHandle = false">取 消</el-button>
            <el-button :loading="loading" type="primary" @click="submitPassword('form')">确定</el-button>
          </el-form>
        </el-dialog>
