<!-- 百事贝管理系统后台商品-商品管理 -->
<template>
  <common-tpl class="column-public-wrap" footer>
    <template slot="main">
      ...
      <el-form :model="formData" :rules="rules" ref="formData" label-width="150px">
        ...
        <!-- 关联商品 -->
        <div class="relation pos-r" v-if="formData.columnType === 1">
          <gray-title title="关联商品"></gray-title>

          <!-- 关联商品组件 -->
          <relation-public :columnId="columnId" @change="relationChange"></relation-public>
    ...
    submitForm (formName) {
      ...
      this.$refs[formName].validate((valid) => {
        ...
        this.$http.post(url, {
          ...
          goodIds: this.formData.columnType === 1 ? goodIds : null,         // 是 Array 栏目所关联的商品ID集合
          ...
          this.$router.push('/admin/goods/column/manage/index')
        })
      })
    }
  }
