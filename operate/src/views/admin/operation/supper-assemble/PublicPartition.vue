  ...
  <common-tpl class="luckybuy-index-wrap" footer>
    <template slot="main" >
      <el-form :model="formData" ref="formData" label-width="120px" v-loading="loading">
        <br>
        <activities-public @initData="getInitData" @change="getChangeData"></activities-public>
        <!-- 商品设置 -->
        <gray-title title="商品设置">
          <el-button slot="right" size="small" type="primary" round style="margin-top: -15px; right: 7px; top: 50%;" class="pos-a" @click="relationVisible = true"><i class="el-icon-plus"></i> 添加拼团商品</el-button>
        </gray-title>
        <br>
