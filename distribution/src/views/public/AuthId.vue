  ...
  <div class="auth-id-wrap">
    <el-form :model="formData" :rules="rules" ref="verifiForm" label-position="right" label-width='110px'>
      ...
      <el-form-item inline label='身份证号：' prop='idNumber'>
        <el-input placeholder='请输入身份证号' v-model="formData.idNumber" :maxlength="18"></el-input>
      </el-form-item>
  ...
  methods: {
    ...
    submitForm (formName) {
      this.$refs[formName].validate((valid) => {
        ...
        // ajax ...
        this.$http.post('@ROOT_API/accountSetController/validCard', {
