  ...
  <div class="pos-r relation-public-wrap">
    ...
    <div class="table-left fl-l">
      <div class="pos-r search-wrap">
        ...
        <el-input placeholder="会员手机/姓名" v-model="leftSearchText" @keyup.enter.native="getRelationAllGoodsList(1)">
          <el-select v-model="listLeftPoints" placeholder="选择会员等级" slot="prepend">
    ...
    <div class="table-right fl-r">
      <div class="pos-r search-wrap">
        <h2 class="fw-n pos-a">商品类型：</h2>
        <el-input placeholder="会员手机/姓名" v-model="rightSearchText" @keyup.enter.native="searchRightHandle()">
          <el-select v-model="listRightPoints" placeholder="选择会员等级" slot="prepend">
            <el-option label="全部" value=""></el-option>
            <el-option label="支持积分兑换" :value="1"></el-option>
            <el-option label="不支持积分兑换" :value="0"></el-option>
          </el-select>
