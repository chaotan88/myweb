      ...
      <el-form label-position="right" label-width="220px" class="ta-l" :model="formData" :rules="rules" ref="form">
        ...
        <div class="form-item-group">
          ...
          <template v-else>
            ...
            <el-form-item label="用户证件号：">{{initData.idCard | filterEmpty}}</el-form-item>
            <el-form-item label="用户实名：">{{initData.cardName | filterEmpty}}</el-form-item>
          </template>
        </div>
        ...
        <div class="form-item-group">
          ...
          <template v-if="formData.dealWithStatus === 2">
            <el-form-item label="上传流水号：" prop="paymentNo" :style="{padding: initData.dealWithStatus === 1 ? '10px 0' : ''}">
              <template v-if="initData.dealWithStatus === 1">
