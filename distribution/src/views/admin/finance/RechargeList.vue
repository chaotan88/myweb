  ...
  <common-tpl class="finance-list-wrap">
    ...
    <template slot="main">
      <el-table :data="tableData" style="width: 100%" v-loading="loading" element-loading-text="加载中">
        <el-table-column fixed prop="customerName" label="会员姓名" min-width="100">
          <template slot-scope="scope">{{scope.row.customerName | filterEmpty}}</template>
        </el-table-column>
        <el-table-column prop="customerPhone" label="手机号" min-width="120">
        ...
        <template v-if="pageType !== 1">
          <el-table-column prop="consumePoints" :label="pageType === 3 ? '消费积分扣除（个）' : '消费积分充值（个）'" min-width="160">
          ...
          <el-table-column prop="cashPoints" label="通用积分充值（个）" min-width="160">
            <template slot-scope="scope">
          ...
          <el-table-column prop="amountOfMoney" :label="pageType === 3 ? '余额扣除（元）' : '余额充值（元）'" min-width="130">
            <template slot-scope="scope">
          ...
          <el-table-column prop="amountOfMoney" :label="pageType === 3 ? '扣款时间' : '充值时间'" min-width="160">
