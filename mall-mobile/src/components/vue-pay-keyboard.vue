            ...
            <div class="key-box" v-if="keyShow">
              ...
              <div class="forgetPwd" @click="forgetPwd">忘记支付密码</div>
                ...
                <div class="item v-1px-t">
                    ...
                    <div class="key v-1px-l" style="background: #e8e8e8" @touchstart="del($event)" @touchend="inputEnd($event,'del')">x
                    </div>
                </div>
            </div>
