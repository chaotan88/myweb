    ...
    <div class="shopCart-option" v-for="(ite, ind) in cartList">
      ...
      <div class="shopCart-shop">
        ...
        <div class="shopCart-shop-logo">
          <img :src="ite.shopLogo" v-if="ite.shopLogo">
      ...
      <swipeout class="shopCart-box">
        <swipeout-item transition-mode="reveal" v-for="(v,index) in ite.list" :key="index">
          <div slot="right-menu">
            <swipeout-button @click.native="shopCartAddCollectFun(v)" type="warn" class="moveCart" :width="70"> 
              <p>移入</p>
              <p>收藏</p>
            </swipeout-button>
            <swipeout-button @click.native="shopCartDelFun(v)" type="primary" class="delCart" :width="70">删除</swipeout-button>
          </div>
          <!--内容-->
              ...
              <div class="send-li-right">
                ...
                <div class="calculate-box">
                  ...
                  <div class="add-subtract">
                    {{v.goodsNum}}
                    <com-cartcontrol @countFun="countFun" :ind="ind" :index="index" :good="cartList" :goodsNum="v.goodsNum"></com-cartcontrol>
                  </div>
                </div>
              </div>
            </div>
    ...
    methods: {
      ...
      */
      isAllCheck () {
        ...
        this.allCheckType = arr.length === this.allListLen ? !!true : !!false                 // 全选按钮状态
      },
      /**
       * 购物车店铺选择按钮点击
      */
      ...
      */
      oneCheckFun (v, ind) {
        ...
        shopList.shopCheckSte = shopArr.length === shopList.list.length ? !!true : !!false        // 店铺按钮状态
        this.isAllCheck() // 是否全选
        this.totalPriceFun()
      },
      /**
