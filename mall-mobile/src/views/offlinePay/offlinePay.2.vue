<template>
  <div class="offlinePay">
    <div>
      ...
      <img :src="voucherImg | filterImgUrl" class="offlinePay-voucher" v-if="voucherImg">
      <div class="offlinePay-upload">
      ...
      submissionAudit () {
        ...
        this.$http.get(this.api.offlinePay, {
          params: {
            ...
            paymentVoucher: this.voucherImg,
