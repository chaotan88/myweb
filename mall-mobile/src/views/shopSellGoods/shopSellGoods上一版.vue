<template>
  <div style="padding-bottom: 1rem;">
    ...
    <!--取消售卖的弹框-->
    <div class="cancelYoCover" v-if="maskCover"></div>
    <div class="cancelYoInfo" v-if="maskInfo">
      <div class="cancelYoInfoTitle">取消售卖<img :src="aaaxxx" @click="guanbi"/></div>
      <div class="cancelAfer">取消售卖后，退换以下内容</div>
      <div class="cancelList">
        <div class="cancelList-nav">销售名额:<span>2</span>个</div>
        <div class="cancelList-nav">金额:<span>200</span>元</div>
        <div class="cancelList-nav">批发券:<span>200</span></div>
      </div>
