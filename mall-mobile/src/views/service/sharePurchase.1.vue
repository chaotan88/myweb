<template>
  <div>
    <!-- 分享内容 -->
    <create-share-img :shareData="shareCon" ref="imageWrapper"></create-share-img>    
    <!-- 内容 -->
                  ...
                  <div class="con-tag">
                    <template v-if="pageType !== 'share'">
                      ...
                      <p v-if="item.beInviterIfGetGoldPoints">
                        <span>送</span>
                        <span>{{item.beInviterGetGoldPoints}}金币</span>
                      </p>
                      <p>
                        <span>获</span>
            ...
            <li v-for="(item, index) in remoedList" v-if="index >= 3" @click="goDetail(item)">
              ...
              <div class="list-con">
                ...
                <div class="con-tag" v-if="pageType !== 'share'">
                  <span v-if="item.beInviterIfGetGoldPoints"><i>送</i>.{{item.beInviterGetGoldPoints}}金币</span>
...
export default {
  ...
  methods: {
    ...
    */
    createImg () {
      console.log(this.$refs.imageWrapper.$el)
      setTimeout(() => {
        html2canvas(this.$refs.imageWrapper.$el, {
    ...
    */
    toImage (v) {
      ...
      if (v.mainImage && v.mainImage.match(/http/gi)) {
