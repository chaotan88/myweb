        ...
        <div class="attributeType-box" style="border-top:1px solid #fff;">
          <div class="fixedBox">
            ...
            <div class="goodInfor-box">
              <ul class="goodInfor-ul">
                ...
                <li class="right">
                  <span class="price">￥{{popUseData.goodsSpecialPrice ? popUseData.goodsSpecialPrice : popUseData.goodsPrice | moneyFilter}}</span>
          ...
          <div class="sizeColor-box">
            <div class="size-color" v-for="(v,index) in popUseData.goodsAttributeList" v-if="v.attributeValList.length > 0">
              <span class="type" v-if="v.attributeName && v.attributeId">{{v.attributeName}}</span>
              <ul class="options-ul clr">
                <!--选择属性-->
                <template>
                  <li :class="item.active ? 'attributeActive' : ''" v-for="(item,i) in v.attributeValList" @click="selectedAttributeFun(v.attributeValList, item)" v-if="item.attributeValId">
                      {{item.attributeVal}}
                  </li>
                </template>
              </ul>
