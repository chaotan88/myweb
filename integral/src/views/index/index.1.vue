      ...
      <div class="user-wrap pos-r">
        <div class="user-cen pos-r">
          ...
          <div class="upgrade-wrap pos-r">
            <div class="upgrade-left pos-a ta-c" @click="handleUpgrad">
              <svg class="icon icon--xiazaigengxin va-m" aria-hidden="true">
                <use xlink:href="#icon--xiazaigengxin"></use>
              </svg>
              <span>我要升级</span>
            </div>
            <span class="line pos-a"></span>
            <div class="upgrade-right pos-a ta-c" @click="$router.push('/myAppliy')">
              <svg class="icon icon-ziyuan1 va-m" aria-hidden="true">
      ...
      <ul>
        ...
        <li>
          <router-link to="/recharge">
            <div>
              <img src="../../assets/images/plan-icon2.jpg" >
            </div>
            <div>预付充值</div>
          </router-link>
        </li>
