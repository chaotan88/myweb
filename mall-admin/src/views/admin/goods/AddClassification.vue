  ...
  <div class="add-classification-wrap">
    <div class="content-wrap">
      <div class="classification-form-wrap">
        <el-form :model="form" :rules="rules" ref="addClassificationForm">
          <el-row>
...
<script>
  export default {
    ...
    methods: {
      ...
      confirm: function () {
        // 确定
        this.form.goodsTypeLevel = parseInt(this.selectedNode.goodsTypeLevel) + 1 + ''
        this.form.parentId = this.selectedNode.goodsTypeId
        this.form.parentName = this.selectedNode.goodsType
        ...
        .then((res) => {
          if (res.data.res === 1) {
            ...
            this.$message.error(res.data.result + ',请重新输入排序')
          }
        })
      }
    },
