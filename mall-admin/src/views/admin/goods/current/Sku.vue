          ...
          <tr v-for="(item, index) in formData.specTableData" v-if="item.visible !== false">
            ...
            <td class="pd-r">
              ...
              <span title="一键同步" class="pos-a sync-btn">
                <svg class="icon icon-jiantou3 cursor-p full-wrap" aria-hidden="true" v-if="index === 0 && formData.specTableData.length > 1" @click="handleSync('externalNo')">
            ...
            <td class="pd-r" v-if="pageType !== 1">
              ...
              <span title="一键同步" class="pos-a sync-btn">
                <svg class="icon icon-jiantou3 cursor-p full-wrap" aria-hidden="true" v-if="index === 0 && formData.specTableData.length > 1" @click="handleSync('updateGoodsNum')">
                  <use xlink:href="#icon-jiantou3"></use>
                </svg>
              </span>
            </td>
            ...
            <td class="pd-r">
              ...
              <span title="一键同步" class="pos-a sync-btn">
                <svg class="icon icon-jiantou3 cursor-p full-wrap" aria-hidden="true" v-if="index === 0 && formData.specTableData.length > 1" @click="handleSync('buyingPrice')">
                  <use xlink:href="#icon-jiantou3"></use>
                </svg>
              </span>
            </td>
            ...
            <td class="pd-r">
              ...
              <span title="一键同步" class="pos-a sync-btn">
                <svg class="icon icon-jiantou3 cursor-p full-wrap" aria-hidden="true" v-if="index === 0 && formData.specTableData.length > 1" @click="handleSync('goodsPrice')">
                  <use xlink:href="#icon-jiantou3"></use>
                </svg>
              </span>
            </td>
            <!-- <td class="pd-l pd-r">
              ...
              <span title="一键同步" class="pos-a sync-btn">
                <svg class="icon icon-jiantou3 cursor-p full-wrap" aria-hidden="true" v-if="index === 0 && formData.specTableData.length > 1" @click="handleSync('goodsSpecialPrice')">
                  <use xlink:href="#icon-jiantou3"></use>
                </svg>
              </span>
            </td>
            <td class="pd-l pd-r">
              ...
              <span title="一键同步" class="pos-a sync-btn">
                <svg class="icon icon-jiantou3 cursor-p full-wrap" aria-hidden="true" v-if="index === 0 && formData.specTableData.length > 1" @click="handleSync('points')">
                  <use xlink:href="#icon-jiantou3"></use>
                </svg>
              </span>
            </td> -->
...
export default {
  ...
  methods: {
    ...
    handleCreateAttributeBefore (type) {
      if (!this.goodsTypeId || this.goodsTypeLevel !== 3) {
        this.$message({
          message: '请选择商品三级分类',
          duration: 1500,
          type: 'error'
