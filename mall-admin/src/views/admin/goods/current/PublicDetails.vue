<!-- 商品管理 - sku -->
<template>
  <common-tpl class="pos-r goods-manage-public" footer :collapse="false">
    <!-- 头部 -->
      ...
      <el-form :model="formData"  ref="formData" label-width="180px">
        ...
        <div class="commodity-details">
          ...
          <el-form-item label="商品图片：" class="picture">
            <thumbnail-component :drag="true" :link="true" :empty="false" :list="formData.uploadFileList" :auto-delete="false" move :styles="{width: '100px', height: '100px', 'margin-right': '10px'}">
            </thumbnail-component>
          ...
          <div v-show="formData.spec === 0">
            ...
            <el-form-item label="库存：" prop="goodsNum">{{formData.goodsNum}}</el-form-item>
            <el-form-item label="进货价：" prop="purchasePrice" style="margin-bottom: 20px;">{{formData.purchasePrice}}</el-form-item>
            <el-form-item label="销售价：" prop="salePrice" style="margin-bottom: 20px;">{{formData.salePrice}}</el-form-item>
          </div>
