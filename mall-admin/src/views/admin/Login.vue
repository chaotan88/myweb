...
<template>
  <div class="full-wrap pos-a admin-login-wrap">
    <div class="pos-a login-cen">
      <h1 class="ta-c"><img class="d-ib" src="../../assets/img/login-logo.png"></h1>
      <h2 class="fw-n ta-c">中腾供应商管理系统</h2>
      <el-form :model="formData" :rules="rules" ref="form" class="form-wrap">
        <el-form-item label="账户名：" class="pos-r" prop="userName">
          <el-input v-model.trim="formData.userName" @keyup.enter.native="loginHandle('form')"></el-input>
        </el-form-item>
        <el-form-item label="密　码：" class="pos-r" prop="password">
          <el-input type="password" v-model.trim="formData.password" @keyup.enter.native="loginHandle('form')"></el-input>
        </el-form-item>
