      ...
      <div class="list">
        ...
        <div class="line">
          <el-form :inline="true" :model="searchData">
            ...
            <el-form-item>
              <el-button class="add-btn"  @click="syncDataByDevice">
        ...
        <el-table :data="itemList">
          ...
          <el-table-column :label="$t('device.roomNumber')">
          ...
          <el-table-column :label="$t('device.phone1')" show-overflow-tooltip>
            <template slot-scope="props">
              <p>{{ props.row.phone1 }}</p>
            </template>
          </el-table-column>
          <el-table-column :label="$t('device.phone2')" show-overflow-tooltip>
            <template slot-scope="props">
              <p>{{ props.row.phone2 }}</p>
            </template>
          </el-table-column>
          <el-table-column :label="$t('device.phone3')" show-overflow-tooltip>
            <template slot-scope="props">
          ...
          <el-table-column prop="operation" :label="$t('common.operation')" width="200">
            <template slot-scope="props">
