      ...
      <ul>
        <li class="green">
          ...
          <div>
            ...
            <p :title="$t('console.deviceTotal')">{{$t("console.deviceTotal")}}</p>
          </div>
        </li>
        <li class="Purple">
          <img src="../../../../static/img/Hico2.png">
          <div>
            <p>{{StaticData.linkDeviceTotal}}</p>
            <p :title="$t('console.linkDeviceTotal')">{{$t("console.linkDeviceTotal")}}</p>
          </div>
        </li>
        <li class="red">
          <img src="../../../../static/img/Hico3.png">
          <div>
            <p>{{StaticData.exceptionDeviceTotal}}</p>
            <p :title="$t('console.exceptionDeviceTotal')">{{$t("console.exceptionDeviceTotal")}}</p>
          </div>
        </li>
      </ul>
    </div>
...
export default {
  data () {
    return {
      ...
      orderDate: [],
      saleDate: [],
      center: {lat: -8.183014, lng: 52.872377},
      address: '',
      addressList: []
    }
  },
