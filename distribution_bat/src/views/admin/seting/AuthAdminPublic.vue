...
export default {
  ...
  methods: {
     ...
     */
    getAdminInfo () {
      this.$http.post('@ROOT_API/manageUserController/info', {
        id: this.adminId
      }).then((res) => {
    ...
    submitForm (formName) {
      this.$refs[formName].validate((valid) => {
        ...
        console.log(curGroupObj)
        let url = this.$route.path.match(/add/gi) ? '@ROOT_API/manageUserController/add' : '@ROOT_API/manageUserController/update'
        this.$http.post(url, {
          id: this.adminId,                          // 主键
